...
MODEL_API_KEY2 = "811c078c-00a9-468e-94f6-3473e816f7c1"
...
class LLM:
    def __init__(self, temperature=0.0, top_p=1):
        ...
        self.client2 = OpenAI(base_url=MODEL_BASE_URL, api_key=MODEL_API_KEY2)
        self.client_list = [self.client, self.client1, self.client2]
        self.switch_flag = 0
    ...
    def get_response(self, prompt):
        ...
        while True:
            try:
                completion = self.client_list[self.switch_flag].chat.completions.create(
                    model=MODEL_NAME,
                    messages=prompt,
                    stream=True,
                ...
                self.switch_flag = (self.switch_flag + 1) % 3
                continue
